...
** 보조비목 및 세목별로 사용 가능한 경비 항목
1. 인건비 (110)
보수(01): 정규직, 연봉제, 성과급, 퇴직금 등

기타직보수(02): 계약직, 청원경찰 등

상용임금(03): 강사, 별정직, 무기계약직

일용임금(04): 임시직, 공익요원

기타인건비(05): 자문료, 통역료, 회의참석비 등

2. 운영비 (210)
일반수용비(01): 사무용품, 인쇄물, 광고, 홍보물, 회의비

공공요금 및 제세(02): 전기, 수도, 전화료, 세금, 보증금

피복비(03): 제복, 침구류, 작업복

급량비(04): 식비, 조리원 인건비

특근매식비(05): 야근, 주말 근무자 식대

일·숙직비(06): 당직자 식대

임차료(07): 차량, 건물, 장비 등 임대료

유류비 등(08): 난방유, 보일러 연료 등

시설장비 유지비(09): 비품·기계 수리, 통신장비 유지

차량비 등(10): 차량 연료, 정비, 용품

재료비(11): 실험재료, 시약, 사료, 씨앗

복리후생비(12): 4대보험, 동호회 지원, 복지포인트 등

시험연구비(13): 연구와 관련된 운영비

일반용역비(14): 행사·채용 등 외주

관리용역비(15): 시설·전산 유지보수

기타운영비(16): 약품비, 자체교육비 등
...
국외교육여비(03): 장·단기 국외교육훈련

4. 업무추진비 (240)
사업추진비(01): 간담회, 연회, 체육대회 등
...
8. 민간이전 (320)
민간경상보조(01), 민간위탁사업비(02), 연금지급금(03), 보험금(04), 이차보전금(05), 교정비(06) 등
...
12. 자산취득·건설 관련 (410~430)
토지매입비, 건설비, 시설비, 자산취득비, 감리비 등

13. 무형자산 (440)
전세금, 보증금 등

14. 융자금, 출자금, 예치금 (450~490)
15. 정산금 및 상환 (500~510)
집행 후 정산, 차입금 원금 및 이자 상환 등

16. 전출금, 감가상각비, 예탁금, 예수금 등 (610~710)
]
"""
